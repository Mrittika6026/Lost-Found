...
<body>
    <div class= "">
        <form class="" action="uploadFound.php" method="POST" enctype="multipart/form-data">
            <label for="">Please enter the details of the found thing</label><br><br>
            <label for="">Name</label><br>
            <input id="name" type="text" name="name" value="" placeholder="Enter name" required><br><br>
            <label for="">Location</label><br>
            <input id="location" type="text" name="location" value="" placeholder="Enter the location of found" required><br><br>
            <label for="">Choose the image of the found thing</label><br>
            <input id="lostImg" type="file" name="lostImg" value="" required ><br><br>
    ...
    if(isset($_POST['upload'])){
        ...
        $sql = "INSERT INTO foundupload SET
        id = '$id', 
        NAME = '$name',
        location = '$location',
        image = '$lostImg'
